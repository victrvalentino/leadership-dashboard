...
const emptyRecruitmentDept = {
  ...
  hired: '0',
  cancelled: '0',
  positions: [] as { position: string; level: string; hc: string; status: string; leadTime: string; remarks: string }[],
  thisWeek: [] as { text: string }[],
  keyInsight: [] as { text: string }[],
  nextAction: [] as { text: string }[],
}

export const recruitmentDeptDefaults: Record<string, typeof emptyRecruitmentDept> = {
  recruitment_marketing: {
    ...
    cancelled: '8',
    positions: [
      { position: 'Video Editor', level: 'L1', hc: '1', status: 'Hired', leadTime: '21 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Graphic Designer', level: 'L2', hc: '2', status: 'Hired', leadTime: '10 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'SEO', level: 'L2', hc: '1', status: 'Hold', leadTime: '7 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Videographer', level: 'L1', hc: '1', status: 'On Progress', leadTime: '36 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Digital Marketing', level: 'L1', hc: '3', status: 'On Progress', leadTime: '45 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Content Writer', level: 'L2', hc: '1', status: 'On Progress', leadTime: '24 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Copywriter', level: 'L1', hc: '3', status: 'On Progress', leadTime: '21 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
      { position: 'Social Media Specialist', level: 'L2', hc: '1', status: 'Cancelled', leadTime: '20 Days', remarks: '[Remarks 1]|[Remarks 2]|[Remarks 3]' },
    ],
    thisWeek: [{ text: '[Remarks 1]' }, { text: '[Remarks 2]' }, { text: '[Remarks 3]' }],
    keyInsight: [{ text: '[Remarks 1]' }, { text: '[Remarks 2]' }, { text: '[Remarks 3]' }],
    nextAction: [{ text: '[Remarks 1]' }, { text: '[Remarks 2]' }, { text: '[Remarks 3]' }],
  },
  recruitment_operations: { ...emptyRecruitmentDept },
  recruitment_technology: { ...emptyRecruitmentDept },
